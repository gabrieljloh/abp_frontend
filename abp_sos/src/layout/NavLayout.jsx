...
export default function NavLayout() {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`fixed top-0 z-50 w-full transform bg-black px-6 py-5 transition-all duration-500 ease-in-out ${
        ...
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between">
          <div className="sm:mr-8">
            <Link className="flex items-center" to="/dashboard">
              <span className="self-center text-xl font-semibold text-cyan-700">
                SOS
              </span>
            </Link>
          </div>
